function App() {
    ...
    return (
        <div>
            ...
            <input name="widthofbar" type="number" value={widthofbar} onChange={(e) => setWidthOfBar(e.target.value)}>
                </input>
            </label>
...
function BarChart({data, width, height, widthOfBar, dataType}) {
    React.useEffect(() => {
        createBarChart();
    }, [data,widthOfBar]);
    ...
    const createBarChart = () => {
        ...
        const coutries = data.map(country => country.country);
        ...
        .on("mouseover", (d, i) => {
            ...
            tooltip.html(countires[i] + '<br/> $(dataType):' + d)
